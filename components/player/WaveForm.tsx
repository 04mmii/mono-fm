...
const moodColors: Record<
  string,
  { played: string; unplayed: string; glow: string }
> = {
  calm: {
    played: "#6366f1",
    unplayed: "#c7d2fe",
...
export default function WaveForm() {
  const { currentTime, duration, isPlaying, setCurrentTime, currentMood } =
    usePlayerStore();
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 bg-white/60 backdrop-blur-sm rounded-2xl">
      {/* Label */}
            ...
            <div
              ...
              style={{
                ...
                transform: isAnimated
                  ...
                  : "scaleY(1)",
                boxShadow:
                  isPlayed && isAnimated ? `0 0 8px ${colors.glow}` : "none",
              }}
            />
          );
        })}
